...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        FreightTerminal terminal =
                new FreightTerminal("Port of Spain Hub");
        ...
        Package p1 =
                new Package("Alice", "Bob",
                        5.0, 40, 30, 20,
                        "Trinidad");

        Package p2 =
                new Package("Carol", "Dan",
                        2.0, 60, 40, 40,
                        "Barbados", true, 500);

        Package p3 =
                new Package("Eve", "Frank",
                        10.0, 30, 30, 30,
                        "Jamaica");

        Package p4 =
                new Package("Grace", "Hank",
                        3.5, 50, 50, 50,
                        "Barbados", false, 200);

        Package p5 =
                new Package("Ivy", "Jack",
                        8.0, 20, 20, 20,
                        "Trinidad", true, 1000);
        ...
        Package p7 =
                new Package("Mia", "Noah",
                        15.0, 40, 40, 30,
                        "Jamaica", true, 750);

        Package p8 =
                new Package("Olivia", "Pat",
                        6.0, 35, 25, 15,
                        "Grenada");

        Package p9 =
                new Package("Quinn", "Ray",
                        4.0, 45, 35, 25,
                        "Trinidad", false, 100);

        Package p10 =
                new Package("Sara", "Tim",
                        20.0, 80, 60, 50,
                        "Barbados", true, 2000);
